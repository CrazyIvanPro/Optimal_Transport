...
# -*- coding: utf-8 -*-
# =======================================
# File Name: test_raw_gurobi.py
# Purpose  : test raw gurobi solver
# =======================================

from utils import get_params
from raw_gurobi import *
import argparse
import mosek
import time
import sys
...
def main():
    ...
    if args.method == 'primal':
        gurobi_primal_simplex(mu, nu, c)
    elif args.method == 'dual':
        gurobi_dual_simplex(mu, nu, c)
    elif args.method == 'interior':
        gurobi_interior_point(mu, nu, c)
    t = time.time() - start
    print('time     = %.5e' % t)
